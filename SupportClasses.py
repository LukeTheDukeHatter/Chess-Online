...
class ChessBoard:
    def __init__(self, d=False):
        ...
        Locals = d if d else {"a8": "BRook", "b8": "BKnight", "c8": "BBishop", "d8": "BKing", "e8": "BQueen", "f8": "BBishop", "g8": "BKnight", "h8": "BRook",
        ...
        self.Turn = 'W'
        self.board = [[{'name': Locals[self.cti((j, i))], 'moved': False} if self.cti((j, i)) in Locals else {
            'name': ' ', 'moved': True} for i in range(8)] for j in range(8)]
    ...
    def itc(self, i):
        return (8 - int(i[1]), ord(i[0]) - 97)

    def cti(self, r):
        return chr(r[1] + 97) + str(8 - r[0])
